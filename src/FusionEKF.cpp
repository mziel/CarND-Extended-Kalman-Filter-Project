  ...
  if (!is_initialized_) {
    ...
    if (measurement_pack.sensor_type_ == MeasurementPackage::RADAR) {
      ...
      */
      ...
      ekf_.x_(2) = 0.0; // radar measurement does not contain enough information to determine the state variable velocities
      ekf_.x_(3) = 0.0;
    }
    ...
    if (measurement_pack.sensor_type_ == MeasurementPackage::RADAR) {
      ...
      // Validate the measurements
      if (measurements[0] != 0.0 && measurements[1] != 0.0) {
        ekf_.R_ = R_laser_;
